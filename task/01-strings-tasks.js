...
function encodeToRot13(str) {
    function rot_13(letter) {
        let groupLastLetterCode = letter <= "Z" ? 90 : 122;
        let newCode = letter.charCodeAt(0) + 13;
        newCode = (newCode <= groupLastLetterCode) ? newCode : newCode - 26;
        return String.fromCharCode(newCode);
    }
    return str.replace(/[a-zA-Z]/g, rot_13)
}
